...
// De-torched (rs-nanogpt): candle's error.h defines C10_CUDA_CHECK and
// C10_CUDA_KERNEL_LAUNCH_CHECK (aborting on failure), so all 12 call sites
// below compile unchanged. This is the ONLY edit to the upstream backward
// sources.
#include "error.h"
